...
{
    public class UserUpdateAction : IDataAction<User, bool>
    {
        ...
        #region Implementation of IDataAction<User,bool>

        public User Context { get; private set; }
        public bool Execute()
        {
            try
            {
                ...
                {
                    scope.UnitOfWork.RepositoryFor<User>().Save(Context);
                    scope.Commit();
                }
