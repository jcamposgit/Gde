...
{
    public class CommentDeleteAction : IDataAction<BlogComment, bool>
    {
        public CommentDeleteAction(BlogComment comment)
        {
            Context = comment;
        }
        ...
        public bool Execute()
        {
            try
            {
                ...
                {
                    scope.UnitOfWork.RepositoryFor<BlogComment>().Delete(Context);
                    scope.Commit();
                }
